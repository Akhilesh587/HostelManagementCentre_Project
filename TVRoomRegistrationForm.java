...
public class TVRoomRegistrationForm {
    ...
    TVRoomRegistrationForm(String Roomno,double Price)
    {
        ...
        readingroomlabel = new JLabel("TV RoomNo:");
    ...
    private boolean RegisterData()
    {
        try
        {
            ...
            String sql="UPDATE tvroombooking SET username='"+uname+"',status=1,price='"+Price+"' WHERE roomno='"+Roomno+"'";
    ...
    {
        new TVRoomRegistrationForm("T301",300.00);
    }
}
