...
public class TVRoomBooking {
    ...
    TVRoomBooking()
    {
        ...
        label = new JLabel("BOOKING TV ROOM",JLabel.CENTER);
    ...
    private String findRoomNo(String uname)
    {
        try
        {
            ...
            sql = "select roomno from tvroombooking WHERE username = '"+uname+"'";
    ...
    private void displayReadingRooms()
    {
        ...
        try
        {
            ...
            sql = "select roomno from tvroombooking WHERE status='"+status+"'";
            ps = con.prepareStatement(sql);   
            rs = ps.executeQuery();
            ...
            else
            {
                ...
                addroombtn.addActionListener( new ActionListener(){
                        ...
                        roomno = s.toString();
                        new TVRoomRegistrationForm(roomno,300.00);
                        cb.setVisible(false);
    ...
    {
        roomlabel = new JLabel("TV Room No:");
