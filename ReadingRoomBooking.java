...
public class ReadingRoomBooking {
    ...
    ReadingRoomBooking()
    {
        ...
        label = new JLabel("BOOKING READING ROOM",JLabel.CENTER);
    ...
    private String findRoomNo(String uname)
    {
        try
        {
            ...
            sql = "select roomno from readingroombooking WHERE username = '"+uname+"'";
    ...
    private void displayReadingRooms()
    {
        ...
        try
        {
            ...
            sql = "select roomno from readingroombooking WHERE status='"+status+"'";
            ps = con.prepareStatement(sql);   
            rs = ps.executeQuery();
            ...
            else
            {
                ...
                addroombtn.addActionListener( new ActionListener(){
                        ...
                        roomno = s.toString();
                        new RegisterRoomForm(s.toString(),200.00);
                        cb.setVisible(false);
    ...
    {
        roomlabel = new JLabel("Reading Room No:");
