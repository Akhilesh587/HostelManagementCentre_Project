...
public class PlayingRoomRegistrationForm {
    ...
    PlayingRoomRegistrationForm(String Roomno,double Price)
    {
        this.Roomno = Roomno;
        this.Price = Price;
        ...
        readingroomlabel = new JLabel("Playing RoomNo:");
        ...
        price = new JLabel(Double.toString(Price));
        price.setFont(f);
    ...
    private boolean RegisterData()
    {
        try
        {
            ...
            String sql="UPDATE playingroombooking SET username='"+uname+"',status=1,price='"+Price+"' WHERE roomno='"+Roomno+"'";
    ...
    {
        new PlayingRoomRegistrationForm("P401",400.00);
    }
}
